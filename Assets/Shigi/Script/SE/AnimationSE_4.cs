...
public class AnimationSE_4 : MonoBehaviour
{
    // SE
    ...
    public AudioClip SkillsAttackSE_3; // ƒXƒLƒ‹UŒ‚
    ...
    //  ƒXƒLƒ‹UŒ‚
    void SkillsAttack3(string SkillsAttackSE_3)
    {
        this.aud.PlayOneShot(this.SkillsAttackSE_3);
    }
    // ƒXƒLƒ‹UŒ‚
